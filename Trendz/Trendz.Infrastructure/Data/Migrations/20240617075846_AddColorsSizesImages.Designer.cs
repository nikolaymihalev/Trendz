...
namespace Trendz.Data.Migrations
{
    ...
    [Migration("20240617075846_AddColorsSizesImages")]
    partial class AddColorsSizesImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.ProductColor", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int")
                        .HasComment("Product identifier");
                    ...
                    b.ToTable("ProductColors", t =>
                        {
                            t.HasComment("Product Color mapping entity");
                        });
                });

            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProductImages", t =>
                        {
                            t.HasComment("Product image entity");
                        });
                });

            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.ProductSize", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int")
                        .HasComment("Product identifier");
                    ...
                    b.ToTable("ProductSizes", t =>
                        {
                            t.HasComment("Product Size mapping entity");
                        });
                });
            ...
            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.ProductColor", b =>
                {
                    b.HasOne("Trendz.Infrastructure.Data.Models.Color", "Color")
            ...
            modelBuilder.Entity("Trendz.Infrastructure.Data.Models.ProductSize", b =>
                {
                    ...
                    b.HasOne("Trendz.Infrastructure.Data.Models.Size", "Size")
                        .WithMany("ProductSizes")
